...
from xla.python.profiler import fake_profile_data
...
class ProfileDataTest(absltest.TestCase):
  ...
  def test_find_plane_with_name(self):
    profile = fake_profile_data.from_text_proto("""
        planes { name: "a" }
        planes { name: "b" }
        """)
  ...
  def test_visit_space(self):
    space = fake_profile_data.from_text_proto("""
        planes { name: "a" }
        planes { name: "b" }
        """)
  ...
  def test_visit_empty_plane(self):
    profile = fake_profile_data.from_text_proto('planes {}')
  ...
  def test_create_profile_data_from_file(self):
    serialized = fake_profile_data.text_proto_to_serialized_xspace("""
        planes { name: "a" }
        planes { name: "b" }
        """)
